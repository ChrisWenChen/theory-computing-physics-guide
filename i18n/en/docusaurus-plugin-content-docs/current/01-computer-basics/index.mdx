  ...
  <div style={{display: 'grid', gridTemplateColumns: '1fr auto 1fr auto 1fr', alignItems: 'center', gap: '8px'}}>
    ...
    <div style={{display: 'flex', flexDirection: 'column', gap: '6px'}}>
      <div style={{padding: '10px 14px', borderRadius: '10px', background: '#a855f718', border: '2px solid #a855f740', textAlign: 'center'}}>
        ...
        <div style={{fontSize: '11px', color: '#888'}}>+ Memory (RAM)</div>
      </div>
      <div style={{padding: '10px 14px', borderRadius: '10px', background: '#ec489918', border: '2px solid #ec489940', textAlign: 'center'}}>
        ...
        <div style={{fontSize: '11px', color: '#888'}}>+ VRAM</div>
      </div>
    </div>
    <div style={{fontSize: '24px', color: '#aaa', textAlign: 'center'}}>→</div>
...
Before running large arrays, estimate the memory first: `float64` takes **8 bytes** per element, so 10⁵ × 10⁴ = 10⁹ elements × 8 bytes = **8 GB**.
...
<div style={{maxWidth: '320px', margin: '2rem auto', fontFamily: 'sans-serif'}}>
  {[
    { icon: '🧑‍💻', label: 'You (User)',          sub: null,                              color: '#4f8ef7' },
    { icon: '📦', label: 'Applications',          sub: 'Python · VS Code · Browser',      color: '#a855f7' },
    { icon: '🖥️', label: 'Operating System',     sub: 'macOS / Linux / Windows',         color: '#f97316' },
    { icon: '⚙️', label: 'Hardware',             sub: 'CPU · RAM · Disk · GPU',           color: '#22c55e' },
...
- Better performance scheduling and resource utilization
...
| Concept | A Better Analogy | Meaning |
|---------|-----------------|---------|
| **Program** | A recipe | Code stored on disk — a static set of instructions |
| **Process** | An active cooking session (the kitchen in action) | A running instance of a program, with its own memory and resources |
| **Thread** | A specific worker in the kitchen (one line of work) | An execution flow inside a process; multiple threads can run concurrently |
...
<div style={{margin: '1.5rem auto', maxWidth: '480px', fontFamily: 'sans-serif'}}>
  <div style={{display: 'flex', gap: '12px', alignItems: 'flex-start'}}>
    <div style={{padding: '10px 14px', borderRadius: '10px', background: '#eab30818', border: '2px solid #eab30840', textAlign: 'center', minWidth: '80px'}}>
      ...
      <div style={{fontWeight: '600', fontSize: '13px', marginTop: '4px'}}>Program</div>
      <div style={{fontSize: '11px', color: '#888'}}>Recipe on disk</div>
    </div>
    ...
    <div style={{flex: 1, padding: '10px 14px', borderRadius: '10px', background: '#a855f718', border: '2px solid #a855f740'}}>
      <div style={{fontWeight: '600', fontSize: '13px', marginBottom: '8px'}}>🍳 Process (the kitchen)</div>
...
You don't need to become a "programmer" — you don't need to build polished applications or design complex multi-interface systems. For physics students, programming is a **tool** — like mathematics. You need to master it to the extent that it lets you solve your physics problems.
